...
@interface ZGRActionSheet () {
    ...
    /** 代理 */
    id<ZGRActionSheetDelegate> _delegate;
}
...
@implementation ZGRActionSheet

+ (instancetype)sheetWithTitle:(NSString *)title buttonTitles:(NSArray *)titles redButtonIndex:(NSInteger)buttonIndex delegate:(id<ZGRActionSheetDelegate>)delegate {
...
- (instancetype)initWithTitle:(NSString *)title
    ...
    if (self = [super init]) {
        ...
        if (titles.count) {
            ...
            NSString *bundlePath = [[NSBundle mainBundle] pathForResource:@"ZGRActionSheet" ofType:@"bundle"];
