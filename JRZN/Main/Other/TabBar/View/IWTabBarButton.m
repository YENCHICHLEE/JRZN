...
// 按钮的默认文字颜色
#define  IWTabBarButtonTitleColor (iOS7 ? [UIColor grayColor] : [UIColor grayColor])
// 按钮的选中文字颜色
#define  IWTabBarButtonTitleSelectedColor (iOS7 ? rgb(2, 169, 245) : rgb(248, 139, 0))
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        // 文字颜色
        [self setTitleColor:kTabbarNormalColor forState:UIControlStateNormal];
        [self setTitleColor:kTabbarHighlightedColor forState:UIControlStateSelected];
