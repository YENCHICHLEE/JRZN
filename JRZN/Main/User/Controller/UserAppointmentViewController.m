//
//  UserAppointmentViewController.m
//  JRZN
//
...
#import "UserAppointmentViewController.h"
#import "AppointmentTableViewCell.h"
#import "AppointmentModel.h"

@interface UserAppointmentViewController ()<UITableViewDataSource, UITableViewDelegate>

@property (nonatomic, strong) UITableView *tableView;

@end

@implementation UserAppointmentViewController
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    //    a * model = self.dataArray[indexPath.row];
    AppointmentModel * model;
    
    NSString * identifier = @"AppointmentTableViewCell";
